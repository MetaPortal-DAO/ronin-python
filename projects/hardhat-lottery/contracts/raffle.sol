...
/** @title sample raffl contract
 *  @dev implement chainlink keepers and vrf
 */
contract raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
  ...
  enum RaffleState {
    OPEN,
    CALCULATING
  } // syntactic sugar for uint256 0 = OPEN
  ...
  // its not reading from storage
  // recall constants are compiled in contract binary
